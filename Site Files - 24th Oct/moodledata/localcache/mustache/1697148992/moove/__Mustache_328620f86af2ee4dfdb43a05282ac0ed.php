...
class __Mustache_328620f86af2ee4dfdb43a05282ac0ed extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                ...
                'element' => array($this, 'block34811ea4d817f70516dde6b82c412cf3'),
            ));
...
';
    ...
    public function block34811ea4d817f70516dde6b82c412cf3($context)
    {
        $indent = $buffer = '';
