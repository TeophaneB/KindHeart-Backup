...
class __Mustache_5d143256868d71c8da5950a0dcbc73f9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'blockB33351e88d3f2ed378aec04247ebab4c'),
            ));
...
';
    ...
    public function blockB33351e88d3f2ed378aec04247ebab4c($context)
    {
        $indent = $buffer = '';
